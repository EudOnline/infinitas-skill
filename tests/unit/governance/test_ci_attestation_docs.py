...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("docs/reference/release-attestation.md", "infinitas release verify-attestation"),
        ("docs/reference/release-attestation.md", "infinitas release verify-ci-attestation"),
        (
            "docs/reference/release-attestation.md",
            "infinitas release generate-distribution-manifest",
        ),
        ...
        ("README.md", "infinitas release verify-ci-attestation"),
