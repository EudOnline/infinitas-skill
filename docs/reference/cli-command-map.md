...
| `python3 scripts/inspect-hosted-state.py --database-url URL [--limit N] [--max-queued-jobs N] [--max-running-jobs N] [--max-failed-jobs N] [--max-warning-jobs N] [--alert-webhook-url URL] [--alert-fallback-file PATH] [--json]` | `uv run infinitas server inspect-state --database-url URL [--limit N] [--max-queued-jobs N] [--max-running-jobs N] [--max-failed-jobs N] [--max-warning-jobs N] [--alert-webhook-url URL] [--alert-fallback-file PATH] [--json]` | live shim | 2026-06-30 |
