...
class SkillDraft(Base):
    ...
    updated_by_principal_id: Mapped[int | None] = mapped_column(ForeignKey("principals.id"), nullable=True)
    updated_at: Mapped[DateTime] = mapped_column(DateTime(timezone=True), default=utcnow, onupdate=utcnow)
...
class SkillVersion(Base):
    ...
    created_from_draft_id: Mapped[int | None] = mapped_column(ForeignKey("skill_drafts.id"), nullable=True)
    created_by_principal_id: Mapped[int | None] = mapped_column(ForeignKey("principals.id"), nullable=True)
    created_at: Mapped[DateTime] = mapped_column(DateTime(timezone=True), default=utcnow)
