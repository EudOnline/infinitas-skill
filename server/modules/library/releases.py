...
def release_distribution_summary(
    ...
    *,
    ...
    return {
        ...
        "runtime_state": canonical_runtime.get("state"),
        "runtime_checker": canonical_runtime.get("checker"),
        "runtime_content_sha256": canonical_runtime.get("content_sha256"),
        "runtime_checked_at": canonical_runtime.get("checked_at"),
