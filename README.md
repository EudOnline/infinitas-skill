...
- operator-facing memory operations summary plus rolling drift context now lives behind `uv run infinitas server memory-observability ...`
- operator-facing rolling memory baselines now live behind `uv run infinitas server memory-baselines ...`
